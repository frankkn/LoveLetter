...
- AI 邏輯
  ...
  - 中等/困難：AI 會記憶神父、國王交換、男爵平手等資訊；衛兵優先使用已知資訊猜牌，並按剩餘張數加權猜測；神父優先窺看尚未掌握的對手。
  - 困難：男爵對決後根據輸家手牌推測勝方手牌範圍；男爵改以算牌估算勝率、挑選最有利對象出手（平手視為安全）；侍女在手握高牌或手牌已外洩時提高自保權重；威脅意識會優先針對硬幣領先者施壓。
  - 困難進階情報運用：記得對手握有公主時，會用王子逼其棄牌秒殺；國王偷取高牌僅在場上衛兵用盡時才進行，避免交換後手牌外洩被衛兵反殺。
