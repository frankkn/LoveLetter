...
const zh: TransMap = {
    ...
    'btn.close':         '關閉',
    'save.btn':          '存檔',
    'save.confirmTitle': '確定存檔嗎？',
    'save.resumeTitle':  '回到上一局遊戲中',
    'save.resumeBody':   '按下確認後遊戲繼續。',
    'btn.ok':            '我知道了',
    'btn.back':          '返回',
    'btn.nextRound':     '開始下一局',
    ...
    'log.tieWin':            (names: string) => `${names} 點數與棄牌總和相同，平手共同獲勝，各得 1 枚硬幣！`,
    ...
    'disconnect.hostBanner':       '房主斷線中，請稍候。若超時未連回，本局將解散。',
    'btn.leaveGame':               '離開遊戲',
...
const en: TransMap = {
    ...
    'btn.close':         'Close',
    'save.btn':          'Save',
    'save.confirmTitle': 'Save Game?',
    'save.resumeTitle':  'Resuming Game',
    'save.resumeBody':   'Press Confirm to continue where you left off.',
    'btn.ok':            'Got it',
    'btn.back':          'Back',
    ...
    'log.tieWin':            (names: string) => `${names} tie on card value and discard total — all win the round and each earns a token!`,
    ...
    'disconnect.hostBanner':       'Host disconnected. Waiting for them to return — if they don\'t, the game will be disbanded.',
